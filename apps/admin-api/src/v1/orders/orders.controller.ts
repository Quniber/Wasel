import { Controller, Get, Post, Patch, Param, Body, Query, UseGuards, ParseIntPipe, Req, VERSION_NEUTRAL } from '@nestjs/common';
...
@Controller({ path: 'internal/orders', version: VERSION_NEUTRAL })
